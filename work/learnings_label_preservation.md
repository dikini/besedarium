# Label Preservation in Type-Level Protocols

## Pattern: Preserving Metadata Across Type Transformations

**Problem:** When projecting from global to local protocol types, label information must be preserved to maintain traceability and enhance debugging.
