...
use crate::protocol::foundation::{
    ActionIOTMarker, ChanId, CommMetadata, CommMetadataTrait, GlobalProtocol, LocalProtocol,
    Message, MsgLbl, Role, SupportsActionIO,
};
...
impl<S, R, C, L, AIO> IsDual<TChanEnd<S, R, C, L, AIO>, TChanEnd<S, R, C, L, AIO>> for ()
where
    S: Role,
    R: Role,
    C: ChanId,
...
impl<S, R, C, L, Msg, P, Q, AIO> IsDual<TChanSend<S, R, C, L, Msg, P, AIO>, TChanRecv<R, S, C, L, Msg, Q, AIO>> for ()
where
    S: Role,
    R: Role,
    C: ChanId,
...
impl<R, S, C, L, Msg, P, Q, AIO> IsDual<TChanRecv<R, S, C, L, Msg, P, AIO>, TChanSend<S, R, C, L, Msg, Q, AIO>> for ()
where
    R: Role,
    S: Role,
    C: ChanId,
...
impl<S, R, C, L, Left, Right, LeftDual, RightDual, AIO> IsDual<TChanChoice<S, R, C, L, Left, Right, AIO>, TChanOffer<S, R, C, L, LeftDual, RightDual, AIO>> for ()
where
    S: Role,
    R: Role,
    C: ChanId,
...
impl<S, R, C, L, Left, Right, LeftDual, RightDual, AIO> IsDual<TChanOffer<S, R, C, L, Left, Right, AIO>, TChanChoice<S, R, C, L, LeftDual, RightDual, AIO>> for ()
where
    S: Role,
    R: Role,
    C: ChanId,
...
impl<S, R, C, L, Left, Right, LeftDual, RightDual, IsDisjoint, AIO> IsDual<TChanPar<S, R, C, L, Left, Right, IsDisjoint, AIO>, TChanPar<S, R, C, L, LeftDual, RightDual, IsDisjoint, AIO>> for ()
where
    S: Role,
    R: Role,
    C: ChanId,
...
impl<S, R, C, L, Start, AIO> IsDual<TChanStart<S, R, C, L, Start, AIO>, TChanStart<S, R, C, L, Start, AIO>> for ()
where
    S: Role,
    R: Role,
    C: ChanId,
...
impl<IO1, IO2, M, Msg, P, Q, AIO> IsDual<EpChanSend<IO1, M, Msg, P, AIO>, EpChanRecv<IO2, M, Msg, Q, AIO>> for ()
where
    IO1: SupportsActionIO<AIO>,
    IO2: SupportsActionIO<AIO>,
    M: CommMetadataTrait,
...
impl<IO1, IO2, M, Msg, P, Q, AIO> IsDual<EpChanRecv<IO1, M, Msg, P, AIO>, EpChanSend<IO2, M, Msg, Q, AIO>> for ()
where
    IO1: SupportsActionIO<AIO>,
    IO2: SupportsActionIO<AIO>,
    M: CommMetadataTrait,
...
impl<IO1, IO2, M, Left, Right, LeftDual, RightDual, AIO> IsDual<EpChanChoice<IO1, M, Left, Right, AIO>, EpChanOffer<IO2, M, LeftDual, RightDual, AIO>> for ()
where
    IO1: SupportsActionIO<AIO>,
    IO2: SupportsActionIO<AIO>,
    M: CommMetadataTrait,
...
impl<IO1, IO2, M, Left, Right, LeftDual, RightDual, AIO> IsDual<EpChanOffer<IO1, M, Left, Right, AIO>, EpChanChoice<IO2, M, LeftDual, RightDual, AIO>> for ()
where
    IO1: SupportsActionIO<AIO>,
    IO2: SupportsActionIO<AIO>,
    M: CommMetadataTrait,
...
impl<IO1, IO2, M, Left, Right, LeftDual, RightDual, IsDisjoint, AIO> IsDual<EpChanPar<IO1, M, Left, Right, IsDisjoint, AIO>, EpChanPar<IO2, M, LeftDual, RightDual, IsDisjoint, AIO>> for ()
where
    IO1: SupportsActionIO<AIO>,
    IO2: SupportsActionIO<AIO>,
    M: CommMetadataTrait,
...
impl<IO1, IO2, M, Start, AIO> IsDual<EpChanStart<IO1, M, Start, AIO>, EpChanStart<IO2, M, Start, AIO>> for ()
where
    IO1: SupportsActionIO<AIO>,
    IO2: SupportsActionIO<AIO>,
    M: CommMetadataTrait,
...
///
/// This blanket implementation ensures that any types not covered by the specific
    ...
    ($P:ty, $Q:ty) => {
        const _: () = {
            ...
            where 
                ...
                <() as $crate::protocol::duality::IsDual<$P, $Q>>::Output: $crate::protocol::duality::EqualsTrue
            {}
        };
    };
}
...
macro_rules! assert_not_dual {
    ($P:ty, $Q:ty) => {
        const _: () = {
            ...
            where 
                (): $crate::protocol::duality::IsDual<$P, $Q>,
                <() as $crate::protocol::duality::IsDual<$P, $Q>>::Output: $crate::protocol::duality::EqualsFalse
            {}
        };
    };
}
...
mod tests {
    ...
    fn test_global_send_recv_duality() {
        ...
        type End = TChanEnd<Alice, Bob, DefaultChan, RequestLbl, BiDirectionalAction>;
    ...
    fn test_choice_offer_duality() {
        type Meta = CommMetadata<DefaultChan, RequestLbl>;
        type EndType = TChanEnd<Alice, Bob, DefaultChan, RequestLbl, BiDirectionalAction>;
        
        type Choice = TChanChoice<Alice, Bob, DefaultChan, RequestLbl, EndType, EndType, BiDirectionalAction>;
        type Offer = TChanOffer<Alice, Bob, DefaultChan, RequestLbl, EndType, EndType, BiDirectionalAction>;
