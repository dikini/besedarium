...
fn test_tchan_send_creation() {
    ...
    type TestSend = TChanSend<Alice, Bob, DefaultChan, RequestLbl, HelloMsg, TestEnd, BiDirectionalAction>;
...
fn test_tchan_recv_creation() {
    ...
    type TestRecv = TChanRecv<Bob, Alice, DefaultChan, ResponseLbl, HelloMsg, TestEnd, BiDirectionalAction>;
...
fn test_tchan_choice_creation() {
    type TestEnd = TChanEnd<DefaultChan, RequestLbl, BiDirectionalAction>;
    type TestSend = TChanSend<Alice, Bob, DefaultChan, RequestLbl, HelloMsg, TestEnd, BiDirectionalAction>;
    type TestChoice = TChanChoice<Alice, DefaultChan, RequestLbl, TestSend, TestEnd, BiDirectionalAction>;
...
fn test_tchan_par_creation() {
    type TestEnd = TChanEnd<DefaultChan, RequestLbl, BiDirectionalAction>;
    type TestSend = TChanSend<Alice, Bob, DefaultChan, RequestLbl, HelloMsg, TestEnd, BiDirectionalAction>;
    type TestPar = TChanPar<DefaultChan, RequestLbl, TestSend, TestEnd, DisjointMarker, BiDirectionalAction>;
...
fn test_type_safety() {
    ...
    type Chan1Send = TChanSend<Alice, Bob, DefaultChan, RequestLbl, HelloMsg, Chan1End, BiDirectionalAction>;
    ...
    assert_ne!(std::any::TypeId::of::<InputEnd>(), std::any::TypeId::of::<OutputEnd>());
}
...
fn test_metadata_access() {
    type TestSend = TChanSend<Alice, Bob, DefaultChan, RequestLbl, HelloMsg, SimpleChannelEnd, BiDirectionalAction>;
